...
> **git clone** http//.......  создает копию репозитория на свой комп

> **git pull** - получает актуальное состояние удаленного репо + merge

> **git push** - отправляет изменения с компа на удаленный репо

> **git remote** - проверка подключения к удаленному репо
